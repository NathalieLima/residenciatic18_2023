...
class Data 
{
    ...
    public:
        ...
        std::string adicionarZero(int);                                      // Adicionar zero a uma string númerica caso seja < 10
        std::string converterParaTextoExtenso();                             // Converter uma data em texto extenso
        std::string converterParaString();                                   // Converter para o formato de string (ex: 15/12/2003)
